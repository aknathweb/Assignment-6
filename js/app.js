...
function show_news(news_collection) {
    ...
    for (const news of news_collection) {
        ...
        <div class="col"><img src=${news.thumbnail_url} class="img-fluid w-100 w-md-75 mx-auto p-1 p-md-3 my-3 my-md-0"
         alt=" ...">
        </div>
        <div class="col-md-8 col-12  my-auto">
        <h3>${news.title}</h3>
        
        <div class="col overflow-hidden my-3" style="height: 10rem;">
        <p>
        ${news.details.length > 500 ? news.details.slice(0, 500) + "..." : news.details}
                    ...
                    src=${news.author.img}
                    class="img-fluid rounded-circle" style="height:3rem; width:3rem ;" alt="...">
                    ...
                    <span><i class="fa-solid fa-star"></i></span>
                                ...
                                <button type="button" class="btn btn-outline-primary m-2" data-bs-toggle="modal" data-bs-target=#a${news._id}><i
